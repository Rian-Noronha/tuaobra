...
(
    ...
    casa_construcao_id bigint,
    cliente_id bigint,
    CONSTRAINT cliente_casa_construcao_pkey PRIMARY KEY (id),
...
(
    ...
    demanda_id bigint,
    pedreiro_id bigint,
    CONSTRAINT pedreiro_demanda_pkey PRIMARY KEY (id),
    CONSTRAINT fk27a02lfw6n5l1ed57xafntj2c FOREIGN KEY (pedreiro_id)
        REFERENCES public.pedreiro (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk659hondp937516u7p1x1j4ak5 FOREIGN KEY (cliente_id)
        REFERENCES public.cliente (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
